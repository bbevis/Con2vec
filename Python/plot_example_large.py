...
image = mp.Image.create_from_file("./data/FER/validate/emotiondetectio_test.mov")

# STEP 3: Detect face landmarks from the input image.
detection_result = detector.detect_for_video(image)

# STEP 4: Process the detection result. In this case, visualize it.
annotated_image = draw_landmarks_on_image(image.numpy_view(), detection_result)
# cv2_imshow(cv2.cvtColor(annotated_image, cv2.COLOR_RGB2BGR))
# cv2.imshow(cv2.cvtColor('image', annotated_image))
